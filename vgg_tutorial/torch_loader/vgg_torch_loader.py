...
class CustomDataSet(Dataset) :
    def __init__(self, file_path, image_size, transform=None, phase='train') :
        self.image_path_list = self.extract_file(file_path, phase)
        self.image_label_dict = self.extract_label(file_path, phase)
    ...
    def __getitem__(self, idx) :
        ...
        label = self.image_label_dict[raw_label]

        return dst, label

    def extract_file(self, file_path, phase) :
        # if phase=='train' :
        #     file_path = file_path+'/trian'
        # elif phase=='val' :
    ...
    def extract_label(self, file_path, phase) :
        # if phase=='train' :
        #     file_path = file_path+'/trian'
        # elif phase=='val' :
        #     file_path = file_path+'/val'
